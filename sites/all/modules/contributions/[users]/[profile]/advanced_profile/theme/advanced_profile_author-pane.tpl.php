<?php
// $Id: advanced_profile_author-pane.tpl.php,v 1.3.4.8 2009/01/05 05:19:43 michellec Exp $
 ...
 * - $location: Location as reported by the location module.
 */
?>
 ...
 <div class="author-pane-inner">
    <div class="author-pane-name-status author-pane-section">
      ...
      <?php if (!empty($facebook_status_status)): ?>
        <div class="author-pane-line author-facebook-status">&hellip;<?php print $facebook_status_status;  ?></div>
      <?php endif; ?>
  ...
  <div class="author-pane-admin author-pane-section">
    <?php if (!empty($user_stats_ip) || !empty($fasttoggle_block_author)): ?>
