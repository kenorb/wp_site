<?php
// $Id: oauth.lib.php,v 1.1.2.3 2008/10/10 00:44:16 brmassa Exp $
/**
 * @author Andy Smith
 * @author OAuth module Dev Team (port to Drupal and fixed to use Drupal
 *   code compliance)
 * @file
 *  OAuth PHP integration. Its based on Andy Smith code on
 *  http://oauth.googlecode.com/svn/code/php, revision 666
 */
...
class OAuthSignatureMethod_HMAC_SHA1 extends OAuthSignatureMethod {
  ...
  public function build_signature($request, $consumer, $token) {
    ...
    $key_parts = array_map(array('OAuthUtil', 'urlencode_rfc3986'), $key_parts);
...
class OAuthRequest {
  ...
  public static function from_request($http_method=NULL, $http_url=NULL, $parameters=NULL) {
    ...
    else if (@drupal_substr($request_headers['Authorization'], 0, 5) == "OAuth") {
  ...
  public function get_signature_base_string() {
    ...
    $parts = array_map(array('OAuthUtil', 'urlencode_rfc3986'), $parts);
